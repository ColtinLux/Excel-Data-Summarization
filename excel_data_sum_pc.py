...
def att_list_2(sheet, list_length, col, row):
    ...
    for b in inttemp:
    	unduplicated_list.append(b)
    for c in strtemp:
    	unduplicated_list.append(c)
...
def main():
    ...
    rwb = Workbook()
    dest_filename = input("Output Excel Title: ")
    ...
    while continuetill == 'yes':
        sheetname = input("Input Sheet Name/Number: ")
        sheet = wb[sheetname]
        ...
        #==================================================================
        att_continuetill = input("Is there another attribute to summarize? (yes/no) ")
        while att_continuetill == 'yes':

            att_col = input("Attribute Column (Letter): ")
            att_row = 2
        ...
        continuetill = input("Is there another sheet? (yes/no) ")
